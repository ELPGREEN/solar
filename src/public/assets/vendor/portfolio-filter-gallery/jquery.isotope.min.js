// Filename: public/assets/vendor/portfolio-filter-gallery/jquery.isotope.min.js
...
/*
import {add} from 'public/assets/vendor/portfolio-filter-gallery/jquery.isotope.min.js'
$w.onReady(function () {
    let sum = add(6,7);
    console.log(sum);
});
