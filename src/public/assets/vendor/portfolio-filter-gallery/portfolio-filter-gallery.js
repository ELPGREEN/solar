// Filename: public/assets/vendor/portfolio-filter-gallery/portfolio-filter-gallery.js
...
/*
import {add} from 'public/assets/vendor/portfolio-filter-gallery/portfolio-filter-gallery.js'
$w.onReady(function () {
    let sum = add(6,7);
    console.log(sum);
});
